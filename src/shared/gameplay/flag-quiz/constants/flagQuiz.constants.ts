...
export const FLAG_QUIZ_OPTION_COUNT = 3;
export const FLAG_QUIZ_TOTAL_ROUNDS = 10;
export const DEFAULT_ANSWER_FEEDBACK_DURATION_MS = 1200;

export const BASE_CORRECT_ANSWER_POINTS = 100;
export const STREAK_BONUS_THRESHOLD = 3;
export const STREAK_BONUS_POINTS = 25;

export const FLAG_QUIZ_DIFFICULTIES: readonly FlagQuizDifficulty[] = [
  'easy',
  'medium',
  'hard',
  'expert',
...
export const DIFFICULTY_CONFIG: Readonly<Record<FlagQuizDifficulty, FlagQuizDifficultyConfig>> = {
  easy: {
    label: 'Fácil',
...
export function getDifficultyMultiplier(difficulty: FlagQuizDifficulty): number {
...
export function getDifficultyRoundDistribution(
  ...
  const scaledEntries = FLAG_QUIZ_DIFFICULTIES.map((tier, order) => {

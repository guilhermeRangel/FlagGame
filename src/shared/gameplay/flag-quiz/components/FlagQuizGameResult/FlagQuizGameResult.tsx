...
import { getPerformanceMessage } from '@/shared/gameplay/flag-quiz/utils/flagQuizRules';

type FlagQuizGameResultProps = {
...
export function FlagQuizGameResult({
  difficulty,
  score,
  correctAnswers,
  incorrectAnswers,
  ...
  return (
    <Animated.View entering={FadeInUp.duration(320)} style={styles.container}>
      ...
      <Text style={styles.message}>
        {getPerformanceMessage(correctAnswers, correctAnswers + incorrectAnswers)}
      </Text>

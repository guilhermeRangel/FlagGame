...
type FlagQuizDifficultySelectorProps = {
  readonly onSelect: (difficulty: FlagQuizDifficulty) => void;
};

export function FlagQuizDifficultySelector({ onSelect }: FlagQuizDifficultySelectorProps) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.options}>
        {FLAG_QUIZ_DIFFICULTIES.map((difficulty, index) => {
          const config = DIFFICULTY_CONFIG[difficulty];
          const accessibilityLabel = [
            `${config.label}, nível ${index + 1} de ${FLAG_QUIZ_DIFFICULTIES.length}.`,
            config.description,
                ...
                <View style={styles.cardHeader}>
                  <View style={styles.headingGroup}>
                    <Text style={styles.level}>
                      Nível {index + 1} de {FLAG_QUIZ_DIFFICULTIES.length}
                    </Text>
